...
CREATE POLICY "Allow public insert" ON public.arcenol_corporate_units FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.arcenol_corporate_units FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.arcenol_corporate_units FOR DELETE USING (true);
...
CREATE POLICY "Allow public update" ON public.warehouses FOR UPDATE USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow public insert" ON public.graded_cells FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.graded_cells FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.graded_cells FOR DELETE USING (true);

-- 5. wip_inventory
CREATE POLICY "Allow public select" ON public.wip_inventory FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.wip_inventory FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.wip_inventory FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.wip_inventory FOR DELETE USING (true);
...
CREATE POLICY "Allow public update" ON public.categories FOR UPDATE USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow public insert" ON public.bom_blueprints FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.bom_blueprints FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.bom_blueprints FOR DELETE USING (true);

-- 8. lead_inquiries
CREATE POLICY "Allow public select" ON public.lead_inquiries FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.lead_inquiries FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.lead_inquiries FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.lead_inquiries FOR DELETE USING (true);
...
CREATE POLICY "Allow public update" ON public.invoices FOR UPDATE USING (true) WITH CHECK (true);
...
CREATE POLICY "Allow public insert" ON public.accounting_vouchers FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.accounting_vouchers FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.accounting_vouchers FOR DELETE USING (true);

-- 12. dtc_scans
CREATE POLICY "Allow public select" ON public.dtc_scans FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.dtc_scans FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.dtc_scans FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.dtc_scans FOR DELETE USING (true);

-- 13. marketing_campaigns
CREATE POLICY "Allow public select" ON public.marketing_campaigns FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.marketing_campaigns FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.marketing_campaigns FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.marketing_campaigns FOR DELETE USING (true);

-- 14. batch_qr_labels
CREATE POLICY "Allow public select" ON public.batch_qr_labels FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.batch_qr_labels FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.batch_qr_labels FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.batch_qr_labels FOR DELETE USING (true);

-- 15. plant_tickets
CREATE POLICY "Allow public select" ON public.plant_tickets FOR SELECT USING (true);
CREATE POLICY "Allow public insert" ON public.plant_tickets FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.plant_tickets FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.plant_tickets FOR DELETE USING (true);
...
CREATE POLICY "Allow public insert" ON public.diagnostic_ledger FOR INSERT WITH CHECK (true);
CREATE POLICY "Allow public update" ON public.diagnostic_ledger FOR UPDATE USING (true) WITH CHECK (true);
CREATE POLICY "Allow public delete" ON public.diagnostic_ledger FOR DELETE USING (true);

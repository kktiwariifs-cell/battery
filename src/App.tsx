      ...
      >
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-12 gap-8 items-center justify-center relative z-10">
          ...
          <div className="lg:col-span-5 flex flex-col items-center justify-center relative min-h-[600px]">
            ...
            {/* The Glass Container matching layout/visual exactly */}
            <div className="w-full max-w-[460px] bg-white/[0.07] backdrop-blur-[32px] rounded-[2.2rem] border border-white/15 p-7 md:p-10 shadow-[0_32px_80px_rgba(0,0,0,0.6)] relative overflow-hidden flex flex-col justify-between">
              ...
              <div className="flex flex-col items-center justify-center mt-7">
                <div className="w-12 h-12 rounded-full bg-emerald-500/15 border border-emerald-500/20 flex items-center justify-center text-emerald-400 shadow-inner">
                  <ShieldCheck size={20} className="drop-shadow-[0_0_8px_rgba(52,211,153,0.4)]" />
                </div>
                <span className="text-[10px] font-black tracking-[0.25em] text-slate-400 uppercase mt-2">
                  Secure Login
                </span>
              </div>
            ...
            <div className="mt-8 text-center space-y-2 select-none">
              <span className="text-[9.5px] font-semibold text-slate-500 tracking-wide block">
                v1.0 | &copy; 2026 Digital Communique. All Rights Reserved.
              </span>
              <div className="flex items-center justify-center gap-3 text-[9.5px] text-slate-400 font-bold">
                <a href="#privacy" onClick={(e) => { e.preventDefault(); alert("System Notice: Privacy node terms are managed under Ministry of Electronics and Information Technology regulations."); }} className="hover:text-white transition">Privacy Policy</a>
                <span className="text-slate-600">|</span>
                <a href="#terms" onClick={(e) => { e.preventDefault(); alert("System Notice: Terms of Service comply with Arcenol Energy multi-region cloud contracts."); }} className="hover:text-white transition">Terms of Service</a>
                <span className="text-slate-600">|</span>
                <a href="#help" onClick={(e) => { e.preventDefault(); alert("Central Helpline: Contact +91 79 4028 9200 for database credentials issues."); }} className="hover:text-white transition">Help Center</a>
              </div>
            </div>
